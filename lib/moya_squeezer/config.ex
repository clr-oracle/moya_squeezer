defmodule MoyaSqueezer.Config do
  ...
  @optional_positive_integer_fields ~w(request_timeout_ms step_interval_seconds baseline_window_seconds worker_tick_ms worker_inflight_limit metrics_flush_interval_ms stats_flush_interval_ms total_target_rps initial_active_workers worker_step worker_step_interval_seconds max_active_workers latency_breach_consecutive_windows)a
